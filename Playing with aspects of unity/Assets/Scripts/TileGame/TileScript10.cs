...
public class TileScript10 : MonoBehaviour {
	...
	void Update () {
		GameObject tile = GameObject.Find ("Tile10");
		...
		GameObject LightsObject = GameObject.Find ("OuterLight10"); 
		LightsOnOff lightsScript = LightsObject.GetComponent<LightsOnOff> ();
		
		GameObject LightsObjects = GameObject.Find ("InnerLight10"); 
