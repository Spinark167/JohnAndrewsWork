...
public class TileScript17 : MonoBehaviour {
	...
	void Update () {
		GameObject tile = GameObject.Find ("Tile17");
		...
		GameObject LightsObject = GameObject.Find ("OuterLight17"); 
		LightsOnOff lightsScript = LightsObject.GetComponent<LightsOnOff> ();
		
		GameObject LightsObjects = GameObject.Find ("InnerLight17"); 
