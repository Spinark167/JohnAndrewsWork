...
public class TileScript14 : MonoBehaviour {
	...
	void Update () {
		GameObject tile = GameObject.Find ("Tile14");
		...
		GameObject LightsObject = GameObject.Find ("OuterLight14"); 
		LightsOnOff lightsScript = LightsObject.GetComponent<LightsOnOff> ();
		
		GameObject LightsObjects = GameObject.Find ("InnerLight14"); 
