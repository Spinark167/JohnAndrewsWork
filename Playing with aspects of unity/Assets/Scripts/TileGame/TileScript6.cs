...
public class TileScript6 : MonoBehaviour {
	...
	void Update () {
		GameObject tile = GameObject.Find ("Tile6");
		...
		GameObject LightsObject = GameObject.Find ("OuterLight6"); 
		LightsOnOff lightsScript = LightsObject.GetComponent<LightsOnOff> ();
		
		GameObject LightsObjects = GameObject.Find ("InnerLight6"); 
