...
public class TileScript1 : MonoBehaviour {
	...
	void Update () {
		GameObject tile = GameObject.Find ("Tile1");
		...
		GameObject LightsObject = GameObject.Find ("OuterLight1"); 
		LightsOnOff lightsScript = LightsObject.GetComponent<LightsOnOff> ();

		GameObject LightsObjects = GameObject.Find ("InnerLight1"); 
	...
	/*void OnCollisionEnter( Collision other ) {
		...
		/*if (LightsOnOffScript) {
			LightsOnOffScript.On ();
		} else {
			LightsOnOffScript.Off ();
		};*/
	//}
}
