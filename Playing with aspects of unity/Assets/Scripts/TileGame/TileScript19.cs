...
public class TileScript19 : MonoBehaviour {
	...
	void Update () {
		GameObject tile = GameObject.Find ("Tile19");
		...
		GameObject LightsObject = GameObject.Find ("OuterLight19"); 
		LightsOnOff lightsScript = LightsObject.GetComponent<LightsOnOff> ();
		
		GameObject LightsObjects = GameObject.Find ("InnerLight19"); 
