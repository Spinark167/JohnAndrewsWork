...
public class TileScript12 : MonoBehaviour {
	...
	void Update () {
		GameObject tile = GameObject.Find ("Tile12");
		...
		GameObject LightsObject = GameObject.Find ("OuterLight12"); 
		LightsOnOff lightsScript = LightsObject.GetComponent<LightsOnOff> ();
		
		GameObject LightsObjects = GameObject.Find ("InnerLight12"); 
