...
public class TileScript16 : MonoBehaviour {
	...
	void Update () {
		GameObject tile = GameObject.Find ("Tile16");
		...
		GameObject LightsObject = GameObject.Find ("OuterLight16"); 
		LightsOnOff lightsScript = LightsObject.GetComponent<LightsOnOff> ();
		
		GameObject LightsObjects = GameObject.Find ("InnerLight16"); 
