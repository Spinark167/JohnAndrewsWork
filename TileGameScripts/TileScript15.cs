...
public class TileScript15 : MonoBehaviour {
	...
	void Update () {
		GameObject tile = GameObject.Find ("Tile15");
		...
		GameObject LightsObject = GameObject.Find ("OuterLight15"); 
		LightsOnOff lightsScript = LightsObject.GetComponent<LightsOnOff> ();
		
		GameObject LightsObjects = GameObject.Find ("InnerLight15"); 
