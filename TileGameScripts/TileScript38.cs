...
public class TileScript38 : MonoBehaviour {

	// Update is called once per frame
	void Update () {
		GameObject tile = GameObject.Find ("Tile38");
		...
		GameObject LightsObject = GameObject.Find ("OuterLight38"); 
		LightsOnOff lightsScript = LightsObject.GetComponent<LightsOnOff> ();
		
		GameObject LightsObjects = GameObject.Find ("InnerLight38"); 
