...
public class TileScript8 : MonoBehaviour {
	...
	void Update () {
		GameObject tile = GameObject.Find ("Tile8");
		...
		GameObject LightsObject = GameObject.Find ("OuterLight8"); 
		LightsOnOff lightsScript = LightsObject.GetComponent<LightsOnOff> ();
		
		GameObject LightsObjects = GameObject.Find ("InnerLight8"); 
