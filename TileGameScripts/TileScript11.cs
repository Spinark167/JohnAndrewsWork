...
public class TileScript11 : MonoBehaviour {
	...
	void Update () {
		GameObject tile = GameObject.Find ("Tile11");
		...
		GameObject LightsObject = GameObject.Find ("OuterLight11"); 
		LightsOnOff lightsScript = LightsObject.GetComponent<LightsOnOff> ();
		
		GameObject LightsObjects = GameObject.Find ("InnerLight11"); 
