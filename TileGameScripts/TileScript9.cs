...
public class TileScript9 : MonoBehaviour {
	...
	void Update () {
		GameObject tile = GameObject.Find ("Tile9");
		...
		GameObject LightsObject = GameObject.Find ("OuterLight9"); 
		LightsOnOff lightsScript = LightsObject.GetComponent<LightsOnOff> ();
		
		GameObject LightsObjects = GameObject.Find ("InnerLight9"); 
