...
public class TileScript7 : MonoBehaviour {
	...
	void Update () {
		GameObject tile = GameObject.Find ("Tile7");
		...
		GameObject LightsObject = GameObject.Find ("OuterLight7"); 
		LightsOnOff lightsScript = LightsObject.GetComponent<LightsOnOff> ();
		
		GameObject LightsObjects = GameObject.Find ("InnerLight7"); 
