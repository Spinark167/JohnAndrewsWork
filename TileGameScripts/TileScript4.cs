...
public class TileScript4 : MonoBehaviour {
	...
	void Update () {
		GameObject tile = GameObject.Find ("Tile4");
		...
		GameObject LightsObject = GameObject.Find ("OuterLight4"); 
		LightsOnOff lightsScript = LightsObject.GetComponent<LightsOnOff> ();
		
		GameObject LightsObjects = GameObject.Find ("InnerLight4"); 
