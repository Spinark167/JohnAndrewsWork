...
public class TileScript22 : MonoBehaviour {

	// Update is called once per frame
	void Update () {
		GameObject tile = GameObject.Find ("Tile22");
		...
		GameObject LightsObject = GameObject.Find ("OuterLight22"); 
		LightsOnOff lightsScript = LightsObject.GetComponent<LightsOnOff> ();
		
		GameObject LightsObjects = GameObject.Find ("InnerLight22"); 
