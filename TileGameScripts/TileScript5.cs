...
public class TileScript5 : MonoBehaviour {
	...
	void Update () {
		GameObject tile = GameObject.Find ("Tile5");
		...
		GameObject LightsObject = GameObject.Find ("OuterLight5"); 
		LightsOnOff lightsScript = LightsObject.GetComponent<LightsOnOff> ();
		
		GameObject LightsObjects = GameObject.Find ("InnerLight5"); 
