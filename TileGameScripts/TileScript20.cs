...
public class TileScript20 : MonoBehaviour {
	...
	void Update () {
		GameObject tile = GameObject.Find ("Tile20");
		...
		GameObject LightsObject = GameObject.Find ("OuterLight20"); 
		LightsOnOff lightsScript = LightsObject.GetComponent<LightsOnOff> ();
		
		GameObject LightsObjects = GameObject.Find ("InnerLight20"); 
