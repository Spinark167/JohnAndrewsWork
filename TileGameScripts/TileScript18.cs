...
public class TileScript18 : MonoBehaviour {
	...
	void Update () {
		GameObject tile = GameObject.Find ("Tile18");
		...
		GameObject LightsObject = GameObject.Find ("OuterLight18"); 
		LightsOnOff lightsScript = LightsObject.GetComponent<LightsOnOff> ();
		
		GameObject LightsObjects = GameObject.Find ("InnerLight18"); 
